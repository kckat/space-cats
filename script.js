...
function openSat() {
  document.getElementById('saturnMod').style.display = "block";
}

function closeSat() {
  document.getElementById('saturnMod').style.display = "none";
}

function openJup() {
  document.getElementById('jupiterMod').style.display = "block";
}

function closeJup() {
  document.getElementById('jupiterMod').style.display = "none";
}

function openMar() {
  document.getElementById('marsMod').style.display = "block";
}

function closeMar() {
  document.getElementById('marsMod').style.display = "none";
}

function openVen() {
  document.getElementById('venusMod').style.display = "block";
}

function closeVen() {
  document.getElementById('venusMod').style.display = "none";
}

function openUM() {
  document.getElementById('ursaMod').style.display = "block";
}

function closeUM() {
  document.getElementById('ursaMod').style.display = "none";
}

function openBo() {
  document.getElementById('bootMod').style.display = "block";
}

function closeBo() {
  document.getElementById('bootMod').style.display = "none";
}

function openleo() {
  document.getElementById('leoMod').style.display = "block";
}

function closeleo() {
  document.getElementById('leoMod').style.display = "none";
}
